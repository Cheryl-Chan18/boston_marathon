...
st.header ("Bye Bye")
st.write ("DEATH - Tako wishes to not be eaten or made into a takoyaki")
st.write ("WISH - Tako proceeds to be made into a takoyaki & has successfully entered the human digestive system")
st.write ("HDS - Tako has been digested and is now a pile of waste waiting to be released")
...
selection = st.multiselect("You may select more than one runner : ", all_name) #this is a Label
# test_selection = st.multiselect( Label = "test user selection : ", options = "Andy", "Candy", "Mandy")
